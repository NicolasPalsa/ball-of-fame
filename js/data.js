...
function loadTeamPages() {
  ...
  for (const team of teams.teams) {
    ...
    mainWrapDiv.classList.add("team-page")
    ...
    for (const player of team.players) {
      ...
      const bottomPlayerName = document.createElement('p')
      bottomPlayerName.classList.add('team-page-bottom-player-name')
      bottomPlayerName.innerHTML = player.player_name
