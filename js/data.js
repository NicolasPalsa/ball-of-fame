...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    // Clear previous YouTube errors cozz why not
    const youtubeErrors = [
      "highlight1Error",
      "highlight2Error",
      "highlight3Error",
    ...
    // Validate all 3 YouTube links so that it doesn't look dumb or broken
    ...
    // If validation passes, call your existing save function
    if (isValid) {
